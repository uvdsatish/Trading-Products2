#This script is to calculate daily WAM RS values for sector/ticker
...
def get_tickers(conn):
    cursor = conn.cursor()
    postgreSQL_select_Query = "select sector, ticker from sectors"
...
def update_sectors(conn, dff, table):
    """
...
if __name__ == '__main__':
    ...
    update_sectors(con,rs_d,"rs_sectors")
